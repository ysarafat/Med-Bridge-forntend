      ...
      <div className="max-w-[1440px] mx-auto px-4 ">
        <div className="flex flex-col lg:flex-row gap-10 mt-16 ">
          ...
          <div className="w-full">
            ...
            <p className="text-justify">
              ...
              all united by the common goal of contributing to our community and
              nation. Our members generously offer their time and expertise free
              of charge, driven by a shared sense of responsibility and a
              deep-rooted desire to create meaningful change. At Heath Bridge,
              we believe in the power of collective action and aim to channel
              our collective energy, knowledge, and enthusiasm towards
              initiatives that benefit the greater good. With a strong
              foundation of collaboration and a genuine spirit of service, we
              strive to address pressing social and environmental issues,
              creating a better future for all. Join us in our journey to make a
              difference and be part of a community dedicated to positive
              change.
            </p>
          </div>
        </div>
        <div className="my-8 md:my-10 lg:my-10">
          ...
          <div className="text-justify">
            <p>
              ...
              At Heath Bridge, we envision a brighter, more equitable future for
              our society and country. Our primary focus is on achieving the
              Sustainable Development Goals (SDGs), with a special emphasis on
              SDG-4 (Quality Education), SDG-13 (Climate Action), SDG-16 (Peace,
              Justice, and Strong Institutions), and SDG-17 (Partnerships for
              the Goals). We are resolutely committed to fostering a society
              where opportunity, justice, and sustainability thrive.
            </p>
            <p className="mt-3">
              ...
              education" initiatives. By providing access to quality education,
              we empower individuals to transform their lives and contribute to
              a more prosperous and just Bangladesh.
            </p>
            <p className="mt-1">
        ...
        <div>
          ...
          <div className="text-justify">
            ...
            <p>
              The journey doesn't end there. Heath Bridge has actively taken on
              challenges like stopping child marriage, battling drug addiction,
              and offering economic support to underprivileged students. These
              efforts provide a helping hand to those in need, fostering a more
              prosperous and just society.
            </p>

            <p>
              Environmental sustainability is another cause close to our hearts.
              Through awareness campaigns and tree plantation drives, we
              continue to contribute to a greener, healthier planet.
            </p>
          </div>
        </div>
        <div className="mt-8">
